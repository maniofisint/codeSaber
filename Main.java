...
class DoublyLinkedList2{
    ...
    public static void addTwoList(int n, int m, DoublyLinkedList2 l1, DoublyLinkedList2 l2) {
        if (n == m) {
            int carry = 0;
            for (int i=0;i<=n;i++) {
    ...
    public static void print(DoublyLinkedList2 list) {
